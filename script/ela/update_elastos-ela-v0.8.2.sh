...
update_log()
{
  ...
  echo_info "Update ela to update_elastos-ela-v0.8.2">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
update_node()
{
  ...
  cp elastos-ela-v0.8.2/ela $SCRIPT_PATH/ela/ela
  cp elastos-ela-v0.8.2/ela-cli $SCRIPT_PATH/ela/ela-cli
  ...
  rm -r elastos-ela-v0.8.2-linux-x86_64.tgz elastos-ela-v0.8.2 SHA256SUMS
}
