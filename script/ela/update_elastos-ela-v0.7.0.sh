...
update_node()
{
  ...
  wget https://download.elastos.io/elastos-ela/elastos-ela-v0.7.0/elastos-ela-v0.7.0-linux-x86_64.tgz
  wget https://download.elastos.io/elastos-ela/elastos-ela-v0.7.0/SHA256SUMS
  shasum -c SHA256SUMS
