...
update_node()
{
  ...
  wget https://download.elastos.io/elastos-ela/elastos-ela-v0.3.9/elastos-ela-v0.3.9-linux-x86_64.tgz
  wget https://download.elastos.io/elastos-ela/elastos-ela-v0.3.9/SHA256SUMS
  shasum -c SHA256SUMS
