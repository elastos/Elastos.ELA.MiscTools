...
update_log()
{
  ...
  echo_info "Update esc-oracle to elastos-esc-oracle-v0.1.4.2">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
upgrade_node()
{
  ...
  cp -v elastos-esc-oracle-v0.1.4.2/* $SCRIPT_PATH/esc/esc-oracle/
  echo_info "Starting esc-oracle..."
  $SCRIPT_PATH/node.sh esc-oracle start
  rm -r elastos-esc-oracle-v0.1.4.2.tgz elastos-esc-oracle-v0.1.4.2.sh elastos-esc-oracle-v0.1.4.2 SHA256SUMS
}
