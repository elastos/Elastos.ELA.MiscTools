...
update_log()
{
  ...
  echo_info "Update esc-oracle to elastos-esc-oracle-v0.1.4">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
upgrade_node()
{
  ...
  wget https://download.elastos.io/elastos-esc-oracle/elastos-esc-oracle-v0.1.4/elastos-esc-oracle-v0.1.4.tgz
  wget https://download.elastos.io/elastos-esc-oracle/elastos-esc-oracle-v0.1.4/SHA256SUMS
  shasum -c SHA256SUMS
  tar xf elastos-esc-oracle-v0.1.4.tgz
  echo_info "Stopping esc-oracle..."
  $SCRIPT_PATH/node.sh esc-oracle stop
  echo_info "Replacing esc-oracle..."
  cp -v elastos-esc-oracle-v0.1.4/* $SCRIPT_PATH/esc/esc-oracle/
  echo_info "Starting esc-oracle..."
  $SCRIPT_PATH/node.sh esc-oracle start
  rm -r elastos-esc-oracle-v0.1.4.tgz elastos-esc-oracle-v0.1.4.sh elastos-esc-oracle-v0.1.4 SHA256SUMS
}
