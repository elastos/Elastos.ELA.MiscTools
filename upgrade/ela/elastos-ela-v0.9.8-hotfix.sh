...
update_node()
{
  ...
  if [ "$(uname -m)" == "armv6l" ] || [ "$(uname -m)" == "armv7l" ] || [ "$(uname -m)" == "aarch64" ]; then
    ...
    wget https://download.elastos.io/elastos-ela/elastos-ela-v0.9.8-hotfix/elastos-ela-v0.9.8-hotfix-linux-arm64.tgz
    tar xf elastos-ela-v0.9.8-hotfix-linux-arm64.tgz
    SHA_ELA_1=$(elastos-ela-v0.9.8-hotfix-linux-arm64/ela | cut -d' ' -f1)
    ...
    cp -v elastos-ela-v0.9.8-hotfix-linux-arm64/ela $SCRIPT_PATH/ela/
    cp -v elastos-ela-v0.9.8-hotfix-linux-arm64/ela-cli $SCRIPT_PATH/ela/
    ...
    rm -rf elastos-ela-v0.9.8-hotfix-linux-arm64 elastos-ela-v0.9.8-hotfix-linux-arm64.tgz
