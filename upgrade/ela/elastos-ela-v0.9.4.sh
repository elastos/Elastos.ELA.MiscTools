...
update_log()
{
  ...
  echo_info "Update ela to elastos-ela-v0.9.4">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
  if [ $1 == "succeeded" ]; then
...
update_node()
{
  ...
  wget https://download.elastos.io/elastos-ela/elastos-ela-v0.9.4/elastos-ela-v0.9.4-linux-x86_64.tgz
  tar xf elastos-ela-v0.9.4-linux-x86_64.tgz
  SHA_ELA_1=$(shasum elastos-ela-v0.9.4-linux-x86_64/ela | cut -d' ' -f1)

  echo_info "Stopping ela..."
  $SCRIPT_PATH/node.sh ela stop
  echo_info "Replacing ela..."
  cp -v elastos-ela-v0.9.4-linux-x86_64/ela $SCRIPT_PATH/ela/
  ...
  rm -r elastos-ela-v0.9.4-linux-x86_64.tgz elastos-ela-v0.9.4.sh elastos-ela-v0.9.4-linux-x86_64
}
