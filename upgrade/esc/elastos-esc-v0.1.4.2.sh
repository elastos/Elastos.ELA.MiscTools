...
update_log()
{
  ...
  echo_info "Update esc to elastos-esc-v0.1.4.2">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
upgrade_node()
{
  ...
  cp -v elastos-esc-v0.1.4.2/esc $SCRIPT_PATH/esc/

  echo_info "Starting esc..."
  $SCRIPT_PATH/node.sh esc start
  rm -r elastos-esc-v0.1.4.2-linux-x86_64.tgz elastos-esc-v0.1.4.2.sh elastos-esc-v0.1.4.2 SHA256SUMS
}
