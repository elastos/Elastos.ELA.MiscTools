...
update_log()
{
  ...
  echo_info "Update esc to elastos-esc-v0.2.2">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
upgrade_node()
{
  ...
  wget https://download.elastos.io/elastos-esc/elastos-esc-v0.2.2/elastos-esc-v0.2.2-linux-x86_64.tgz
  wget https://download.elastos.io/elastos-esc/elastos-esc-v0.2.2/SHA256SUMS
  shasum -c SHA256SUMS
  tar xf elastos-esc-v0.2.2-linux-x86_64.tgz
  echo_info "Stopping esc..."
  $SCRIPT_PATH/node.sh esc stop
  echo_info "Replacing esc..."
  cp -v elastos-esc-v0.2.2-linux-x86_64/esc $SCRIPT_PATH/esc/

  echo_info "Starting esc..."
  $SCRIPT_PATH/node.sh esc start
  rm -r elastos-esc-v0.2.2-linux-x86_64.tgz elastos-esc-v0.2.2.sh elastos-esc-v0.2.2-linux-x86_64 SHA256SUMS
}
