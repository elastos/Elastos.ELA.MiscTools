...
update_log()
{
  ...
  echo_info "Update esc to elastos-esc-v0.1.4.3">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
upgrade_node()
{
  ...
  wget https://download.elastos.org/elastos-esc/elastos-esc-v0.1.4.3/elastos-esc-v0.1.4.3-linux-x86_64.tgz
  wget https://download.elastos.org/elastos-esc/elastos-esc-v0.1.4.3/SHA256SUMS
  shasum -c SHA256SUMS
  tar xf elastos-esc-v0.1.4.3-linux-x86_64.tgz
  echo_info "Stopping esc..."
  $SCRIPT_PATH/node.sh esc stop
  echo_info "Replacing esc..."
  cp -v elastos-esc-v0.1.4.3/esc $SCRIPT_PATH/esc/

  echo_info "Starting esc..."
  $SCRIPT_PATH/node.sh esc start
  rm -r elastos-esc-v0.1.4.3-linux-x86_64.tgz elastos-esc-v0.1.4.3.sh elastos-esc-v0.1.4.3 SHA256SUMS
}
