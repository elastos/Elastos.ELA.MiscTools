...
upgrade_node()
{
  ...
  wget https://download.elastos.io/elastos-esc/elastos-esc-v0.1.4.3/elastos-esc-v0.1.4.3-linux-x86_64.tgz
  wget https://download.elastos.io/elastos-esc/elastos-esc-v0.1.4.3/SHA256SUMS
  shasum -c SHA256SUMS
