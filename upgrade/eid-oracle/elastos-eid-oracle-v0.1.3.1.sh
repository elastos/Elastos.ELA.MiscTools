...
update_log()
{
  ...
  echo_info "Update eid-oracle to elastos-eid-oracle-v0.1.3.1">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
upgrade_node()
{
  ...
  cp -v elastos-eid-oracle-v0.1.3.1/* $SCRIPT_PATH/eid/eid-oracle/
  echo_info "Starting eid-oracle..."
  $SCRIPT_PATH/node.sh eid-oracle start
  rm -r elastos-eid-oracle-v0.1.3.1.tgz elastos-eid-oracle-v0.1.3.1.sh elastos-eid-oracle-v0.1.3.1 SHA256SUMS
}
