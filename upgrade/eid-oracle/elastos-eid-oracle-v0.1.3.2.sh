...
upgrade_node()
{
  ...
  wget https://download.elastos.org/elastos-eid-oracle/elastos-eid-oracle-v0.1.3.2/elastos-eid-oracle-v0.1.3.2.tgz
  wget https://download.elastos.org/elastos-eid-oracle/elastos-eid-oracle-v0.1.3.2/SHA256SUMS
  shasum -c SHA256SUMS
