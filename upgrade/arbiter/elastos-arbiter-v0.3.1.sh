...
upgrade_node()
{
  ...
  wget https://download.elastos.org/elastos-arbiter/elastos-arbiter-v0.3.1/elastos-arbiter-v0.3.1-linux-x86_64.tgz
  wget https://download.elastos.org/elastos-arbiter/elastos-arbiter-v0.3.1/SHA256SUMS
  shasum -c SHA256SUMS
