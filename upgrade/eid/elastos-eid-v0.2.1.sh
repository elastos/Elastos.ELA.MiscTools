...
update_log()
{
  ...
  echo_info "Update eid to elastos-eid-v0.2.1">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
  if [ $1 == "succeeded" ]; then
...
upgrade_node()
{
  ...
  wget https://download.elastos.io/elastos-eid/elastos-eid-v0.2.1/elastos-eid-v0.2.1-linux-x86_64.tgz
  tar xf elastos-eid-v0.2.1-linux-x86_64.tgz
  SHA_EID_1=$(shasum elastos-eid-v0.2.1-linux-x86_64/eid | cut -d' ' -f1)
  
  echo_info "Stopping eid..."
  $SCRIPT_PATH/node.sh eid stop
  echo_info "Replacing eid..."
  cp -v elastos-eid-v0.2.1-linux-x86_64/eid $SCRIPT_PATH/eid/
  ...
  rm -r elastos-eid-v0.2.1-linux-x86_64.tgz elastos-eid-v0.2.1.sh elastos-eid-v0.2.1-linux-x86_64
}
