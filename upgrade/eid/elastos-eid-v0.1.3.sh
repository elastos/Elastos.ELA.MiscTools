...
upgrade_node()
{
  ...
  wget https://download.elastos.io/elastos-eid/elastos-eid-v0.1.3/elastos-eid-v0.1.3-linux-x86_64.tgz
  wget https://download.elastos.io/elastos-eid/elastos-eid-v0.1.3/SHA256SUMS
  shasum -c SHA256SUMS
