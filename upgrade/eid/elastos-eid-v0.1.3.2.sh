...
update_log()
{
  ...
  echo_info "Update eid to elastos-eid-v0.1.3.2">>$SCRIPT_PATH/update.log
  echo_info "">>$SCRIPT_PATH/update.log
...
upgrade_node()
{
  ...
  wget https://download.elastos.org/elastos-eid/elastos-eid-v0.1.3.2/elastos-eid-v0.1.3.2-linux-x86_64.tgz
  wget https://download.elastos.org/elastos-eid/elastos-eid-v0.1.3.2/SHA256SUMS
  shasum -c SHA256SUMS
  tar xf elastos-eid-v0.1.3.2-linux-x86_64.tgz
  echo_info "Stopping eid..."
  $SCRIPT_PATH/node.sh eid stop
  echo_info "Replacing eid..."
  cp -v elastos-eid-v0.1.3.2/eid $SCRIPT_PATH/eid/

  echo_info "Removing eid spv... "
  rm -r -v $SCRIPT_PATH/eid/data/header
  rm -r -v $SCRIPT_PATH/eid/data/spv_transaction_info.db
  rm -r -v $SCRIPT_PATH/eid/data/store

  echo_info "Starting eid..."
  $SCRIPT_PATH/node.sh eid start
  rm -r elastos-eid-v0.1.3.2-linux-x86_64.tgz elastos-eid-v0.1.3.2.sh elastos-eid-v0.1.3.2 SHA256SUMS
}
