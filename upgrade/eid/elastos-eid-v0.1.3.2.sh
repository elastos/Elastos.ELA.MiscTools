...
upgrade_node()
{
  ...
  wget https://download.elastos.io/elastos-eid/elastos-eid-v0.1.3.2/elastos-eid-v0.1.3.2-linux-x86_64.tgz
  wget https://download.elastos.io/elastos-eid/elastos-eid-v0.1.3.2/SHA256SUMS
  shasum -c SHA256SUMS
